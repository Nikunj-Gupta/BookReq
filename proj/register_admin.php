...
<?php
	...
	if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		//$sql = "INSERT INTO user (name,email,password,userlevel) VALUES ('$name','$email','$password',3)";
		...
		$sql = "INSERT INTO user (email,password,salt,userlevel) VALUES ('$email','$hashed','$salt',3)";
